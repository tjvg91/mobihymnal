(function () {
    ...
    .controller("homeCtrl", ["$scope", "$state", function ($scope, $state) {
        ...
        /*$scope.watch('$viewContentLoaded', function () {
            console.log("yeah");
            angular.element("iframe").css('height', window.screen.height * window.devicePixelRatio + 'px');
            angular.element("slide").css('height', window.screen.height * window.devicePixelRatio + 'px');
        });*/
    }])
